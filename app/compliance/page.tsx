...
export default function ComplianceNoticePage() {
  return (
    ...
    >
      ...
      <p>NexCall should market measurable capabilities such as answering calls, capturing details, booking approved appointments, and sending summaries. It should not claim guaranteed revenue, guaranteed compliance, or guaranteed human-level accuracy without evidence.</p>
