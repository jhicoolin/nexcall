...
export const metadata: Metadata = {
  title: "Compliance Notice | NexCall",
  description: "Plain-language compliance notice for NexCall claims, security, and regulated workflows."
};
...
export default function ComplianceNoticePage() {
  return (
    ...
    >
      ...
      <p>NexCall should market measurable capabilities such as answering calls, capturing details, supporting appointment requests, and sending summaries. It should not claim guaranteed revenue, guaranteed compliance, or guaranteed human-level accuracy without evidence.</p>
      ...
      <p>Each client is responsible for approving business-specific scripts, approved answer content, handoff rules, recording notices, appointment rules, and customer-facing claims before the AI receptionist goes live.</p>

      <h2>Human-in-the-Loop</h2>
      <p>For sensitive or high-risk conversations, the recommended operating approach is automated intake with human follow-up. The assistant should capture context and route the conversation rather than pretending to be a licensed professional.</p>
    </LegalPage>
  );
}
